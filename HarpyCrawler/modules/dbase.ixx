...
// ============================================================================================================================
	...
	private:		
		...
		void build_crossings(std::vector<harpy::WebPage>& _webPages);
...
void harpy::DBASE::process_pages(std::vector<harpy::WebPage>& _webPages)
{
	...
	write_data(_webPages);

	std::cout << "\n> Building crossings...";

	build_crossings(_webPages);
...
void harpy::DBASE::build_crossings(std::vector<harpy::WebPage>& _webPages)
{
	if (!_webPages.empty())	
	{
		for (auto webpage : _webPages)
